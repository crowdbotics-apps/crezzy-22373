"""crezzy_22373 URL Configuration
...
admin.site.site_header = "Crezzy"
admin.site.site_title = "Crezzy Admin Portal"
admin.site.index_title = "Crezzy Admin"

# swagger
api_info = openapi.Info(
    title="Crezzy API",
    default_version="v1",
    description="API documentation for Crezzy App",
)
